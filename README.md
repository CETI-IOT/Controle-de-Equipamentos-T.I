...
Leitura pela câmera usa o detector nativo do navegador quando disponível e inicia a câmera traseira antes de carregar a lista de câmeras. O seletor permite trocar entre as câmeras disponíveis e atualiza a lista quando algum dispositivo muda. A biblioteca da câmera e a biblioteca de etiquetas são carregadas apenas quando seus recursos são usados. São aceitos QR Code e códigos comuns como Code 128, Code 39, EAN e UPC. Leitores USB ou Bluetooth podem ser usados no modo **Leitor externo** ou diretamente nos campos de patrimônio e solicitante. O aplicativo reconhece a leitura pelo padrão rápido de teclas; quando possível, configure o leitor para enviar Enter ao terminar. A câmera requer permissão do navegador e conexão HTTPS.

Por segurança, navegadores não permitem descobrir silenciosamente todos os periféricos conectados. Leitores que se apresentam como teclado só podem ser reconhecidos quando enviam uma leitura; alguns protocolos HID específicos também dependem de suporte e autorização do navegador.
